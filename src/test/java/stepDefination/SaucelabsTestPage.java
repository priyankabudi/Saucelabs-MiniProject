...
import cts.saucelabs.pages.ChechoutPageWithPageFactory;
...
public class SaucelabsTestPage {
	...
	ChechoutPageWithPageFactory checkout;
	...
	public void clicks_on_checkout_button() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		checkout=PageFactory.initElements(driver, ChechoutPageWithPageFactory.class);
	...
	public void enters_the_personal_details() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		checkout=PageFactory.initElements(driver, ChechoutPageWithPageFactory.class);
		driver.findElement(By.id("first-name")).sendKeys("padma");
